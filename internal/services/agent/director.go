...
• FORBIDDEN patterns (treat these as hard errors):
  ...
  - Self-declaring win/lose conditions in think without tool-verified evidence. "Enemy X is dead therefore we win" in think is pre-deciding. Victory must be verified against WIN COND using actual ack/tool records before calling end_game.
