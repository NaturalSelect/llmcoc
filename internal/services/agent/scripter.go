...
- 禁用人造科技/工程机关解释神话现象: 机械装置、电子设备、声波/振动/频率、传感器、药剂、催眠器、信号标记、安全区/诱导区等都不能作为幻觉、怪物行动或神话影响的真正原因。</mythos_secret>
<rules>
...
<ban>科学术语；用机械装置/电子设备/声波/振动/频率/传感器/药剂/催眠器/信号标记/安全区解释神话现象。</ban>
`
...
- 伪科学/科学术语解释神话；用机械装置/电子设备/声波/振动/频率/传感器/药剂/催眠器/信号标记/安全区解释神话现象；空泛神秘描述。
